...
from main_app.validators import CustomerNameValidator, CustomerPhoneValidator
...
class Customer(models.Model):
    name = models.CharField(
        max_length=100,
        validators=[CustomerNameValidator("Name can only contain letters and spaces")]
    )
    ...
    phone_number = models.CharField(
        max_length=13,
        validators=[CustomerPhoneValidator("Phone number must start with '+359' followed by 9 digits")]
    )
